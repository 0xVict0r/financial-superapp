...
if __name__ == "__main__":
    # run_functions.best_portfolio_performance_estimator(tickers, price_init, years, plotting=False, num_ports=10, monte_carlo_trials=monte_carlo_trials)
    run_functions.portfolio_performance_estimator(
        years, plotting=False, monte_carlo_trials=monte_carlo_trials)
